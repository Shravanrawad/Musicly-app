...
export const HomePage = ({ token, setToken }) => {
  ...
  return (
    <div>
      {userProfile ? (
      <header className="bg-black text-white shadow-md fixed top-0 left-0 w-full z-50 flex items-center justify-between p-4">
      <div
      ...
      <nav className="hidden md:flex space-x-6">
        ...
        <Link className="hover:text-green-500 transition" to={'/search'}>
          Search
        </Link>
